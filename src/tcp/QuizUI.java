...
public class QuizUI extends JFrame {
    ...
    public QuizUI(String username) {
        ...
        ImagePanel centerPanel = new ImagePanel(new BorderLayout(10, 10), 20, Theme.PANEL_BACKGROUND, "/images/peeking.png");
    ...
    static class ExamListRenderer extends DefaultListCellRenderer {
    	private static final long serialVersionUID = 1L;
        private final Icon examIcon;

        public ExamListRenderer() {
            ImageIcon icon = null;
            try {
                ImageIcon originalIcon = new ImageIcon(getClass().getResource("/images/exam.png"));
                ...
                System.err.println("Không tìm thấy icon: /images/exam.png");
            }
            this.examIcon = icon;
        }
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (isSelected) {
                ...
                label.setForeground(Theme.TEXT_LIGHT);
                 ...
                 // --- THAY ĐỔI: Chuyển sang màu xen kẽ trắng/xám ---
                 if (index % 2 == 0) {
                    label.setBackground(Color.WHITE);
                 } else {
                    label.setBackground(Theme.INPUT_BACKGROUND); // Màu xám nhạt từ Theme
                 }
